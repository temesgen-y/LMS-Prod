...
export default function InstructorLiveSessionsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const userId = await getCurrentUserId();
    const supabase = createClient();
    const payload: any = { offering_id: form.offeringId, instructor_id: userId, title: form.title.trim(), platform: form.platform, join_url: form.joinUrl.trim() || null, meeting_id: form.meetingId.trim() || null, passcode: form.passcode.trim() || null, scheduled_at: new Date(form.scheduledAt).toISOString(), duration_mins: durationMins, recording_url: form.recordingUrl.trim() || null, status: form.status, auto_generated: form.autoGenerated };
    let error;
