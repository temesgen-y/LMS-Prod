...
const V_META: Record<string, { label: string; icon: string; severityColor: string }> = {
  ...
  browser_exit:              { label: 'Browser Exit',          icon: '🚪',  severityColor: 'amber'  },
  new_tab_attempt:           { label: 'New Tab Attempt',       icon: '🗂️',  severityColor: 'amber'  },
  window_close_attempt:      { label: 'Close Attempt',         icon: '✖️',  severityColor: 'amber'  },
  // Copy / input
  ...
  drag_attempt:              { label: 'Drag Attempt',          icon: '🤚',  severityColor: 'gray'   },
  ...
  screenshot_attempt:        { label: 'Screenshot Attempt',    icon: '📸',  severityColor: 'yellow' },
  screen_recording_detected: { label: 'Screen Recording',      icon: '🎥',  severityColor: 'red'    },
  ...
  identity_mismatch:         { label: 'Identity Mismatch',     icon: '🆔',  severityColor: 'red'    },
  // Audio
  voice_detected:            { label: 'Suspicious Noise',      icon: '🎤',  severityColor: 'orange' },
  suspicious_noise:          { label: 'Suspicious Noise',      icon: '🎤',  severityColor: 'orange' },
  // Mouse / activity
  unusual_mouse:             { label: 'Unusual Mouse Pattern', icon: '🖱️',  severityColor: 'gray'   },
  long_inactivity:           { label: 'Long Inactivity',       icon: '💤',  severityColor: 'amber'  },
  // Environment
