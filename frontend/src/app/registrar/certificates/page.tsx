  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openIssue} className="px-4 py-2 bg-purple-700 text-white rounded-lg text-sm font-medium hover:bg-purple-800">
          + Issue Certificate
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button onClick={handleIssue} disabled={saving} className="px-4 py-2 bg-purple-700 text-white rounded-lg text-sm disabled:opacity-60">
