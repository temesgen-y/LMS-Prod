...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/registrar/readmissions', label: 'Readmission Requests' },
      { href: '/registrar/clearance', label: 'Clearance Requests' },
    ],
  },
  {
    label: 'STUDENTS',
    items: [
      { href: '/registrar/student-approvals',       label: 'Student Approvals' },
      { href: '/registrar/students',                label: 'Student Records' },
      { href: '/registrar/students/by-department',  label: 'By Department' },
  ...
  },
  {
    label: 'FEE',
    items: [
      { href: '/registrar/fees', label: 'Student Fee Accounts' },
      { href: '/registrar/fees/payment', label: 'Record Payment' },
      { href: '/registrar/fees/statements', label: 'Fee Statements' },
    ],
  },
  {
    label: 'ACADEMIC',
...
export type RegistrarUser = { id: string; name: string; email: string };

export default function RegistrarLayoutClient({
  user,
  children,
}: {
  user: RegistrarUser;
    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <Link href="/registrar/dashboard" className="font-semibold text-lg">
            MULE LMS
          </Link>
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            >
              ...
              <div className="text-left hidden sm:block">
                <div className="text-sm font-medium leading-tight">{user.name || 'Registrar'}</div>
                <div className="text-xs text-white/80">Registrar</div>
              </div>
                  ...
                  <div key={section.label}>
                    ...
                    <div className="space-y-0.5">
                      {section.items.map(item => {
                        const exactOnlyPaths = ['/registrar/dashboard', '/registrar/students'];
